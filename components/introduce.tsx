    ...
    <section className="mb-16">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-md border border-gray-200 dark:border-gray-700">
        <div className="space-y-6 text-gray-700 dark:text-gray-300 leading-relaxed">
          <p className="text-lg">
            스타트업 공동 창업과 금융권 실무 경험을 갖춘 <span className="font-semibold text-blue-600 dark:text-blue-400">백엔드 개발자</span>입니다.
          ...
          <p className="bg-blue-50 dark:bg-gray-700/50 p-4 rounded-lg">
        ...
        <div className="text-right mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
          ...
          <p className="font-signature text-2xl text-blue-600 dark:text-blue-400 mt-2">ChanKim</p>
        </div>
      </div>
    </section>
  );
